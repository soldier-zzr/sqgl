...
class AudioDownloaderApp(ctk.CTk):
    ...
    def _build_ui(self) -> None:
        ...
        self.queue_tree.tag_configure("running", foreground=THEME["primary"])
        self.queue_tree.tag_configure("success", foreground=THEME["success"])
        self.queue_tree.tag_configure("failed", foreground=THEME["danger"])
        self.queue_tree.tag_configure("skipped", foreground=THEME["warning"])
